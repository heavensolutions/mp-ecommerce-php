                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <form action="process.php" method="POST">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>Nombre</td>
                                        <td><input type="text" name="name" value="Lalo"></td>
                                    </tr>
                                    <tr>
                                        <td>Apellido</td>
                                        <td><input type="text" name="surname" value="Landa"></td>
                                    </tr>
                                    <tr>
                                        <td>Email</td>
                                        <td><input type="email" name="email" value="test_user_63274575@testuser.com"></td>
                                    </tr>
                                    <tr>
                                        <td>Teléfono</td>
                                        <td><input type="number" name="cod" value="11"> - <input type="number" name="tel" value="22223333"></td>
                                    </tr>
                                    <th>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="calle" value="Falsa"> <input type="number" name="calle_numero" value="123"></td>
                                    </tr>
                                    <tr>
                                        <td>Código postal</td>
                                        <td><input type="number" name="cp" value="1111"></td>
                                    </tr>
                                    <th>
                                    <td colspan="2"><input type="submit" class="mercadopago-button" value="Pagar la compra"></td>
                                    </th>
                                </table>
                            </form>
                        </div>
